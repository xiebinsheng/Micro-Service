...
namespace TestService.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TestServiceDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TestServiceEfCoreEntityExtensionMappings to extend the IdentityUser entity
